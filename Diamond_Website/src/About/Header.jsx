export default function DiamondHero() {
  return (
    <section className="relative min-h-fit w-full bg-[#0f0f0f] px-6 md:px-12 lg:px-20 py-20 overflow-hidden flex items-center">
      ...
      <div className="relative z-10 max-w-7xl mx-auto w-full">
        ...
        {/* Description */}
        <p className="mt-10 translate-x-[500px] text-[#b3b3b3] text-base md:text-lg lg:text-xl leading-relaxed max-w-3xl">
