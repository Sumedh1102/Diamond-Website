      ...
      subLinks: [
        {
          ...
          path: '#',
          subLinks: [
            { name: 'PROCESS', path: '/our-diamonds/natural/process' },
          ]
        },
        { name: 'LAB-GROWN DIAMONDS', path: '/products' },
      ]
    },
        ...
        <div className="flex items-center flex-shrink-0">
          <NavLink to="/" className="text-white font-light tracking-wider">
            <div className="flex items-center">
              ...
              <span className="text-base sm:text-lg lg:text-xl text-[#B88A6A] mx-0.5 sm:mx-1">KAR</span>
            </div>
